...
`EVAL`---now you're running metacircular interpreter!
...
as a meta-language to direct the set-up, rather than an essential
...
in `eval.mx` as the environment alist passed to outer `EVAL`.
